...
*(Xác định nguyên nhân gốc rễ của sự cố tăng đột biến CPU và IO trong CSDL OLTP khi tải đồng thời cao, và khắc phục bằng cách cấu trúc lại chỉ mục).*
...
*(Lúc 10h sáng, bảng `orders` nhận lượng chèn khổng lồ. Hệ thống bị treo. Bạn có snapshot AWR từ 10h đến 11h).*
...
*(Bạn sẽ thấy chỉ mục Khóa chính của bảng orders chính là thủ phạm).*
...
*(Xây dựng lại thành Chỉ mục khóa đảo ngược để phân tán ngẫu nhiên các ID liên tiếp).*
